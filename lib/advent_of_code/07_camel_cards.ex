defmodule AdventOfCode.CamelCards do
  @moduledoc ~S"""
  # Day 7: Camel Cards
  ...
  the part of Desert Island that is directly above Island Island, making it hard to even get
  there. Normally, they use big machines to move the rocks and filter the sand, but the
  machines have broken down because Desert Island recently stopped receiving the parts they
  ...
  **Find the rank of every hand in your set. What are the total winnings?**
  ...
  defp cards_stength(hand) do
    Enum.map(hand, fn card -> Map.get(@cards, card) end)
  end
end
